...
#echo $description
echo "--------------------------------------------------------------------------------------------------------"
mysql venky<<EOFMYSQL
insert into 76to80lakh(id,isbn13,isbn10,price,specialprice,delivery,stock,binding,title,author,publisher,pages,published,subject,category,description) values($id,'$isbn13','$isbn10','$price','$specialprice','$delivery','$stock','$binding','$title','$author','$publisher','$pages','$published','$subject','$category','$description');
EOFMYSQL
done